...
class Data {
	...
	public static function getModsColumn( pos : Position, file : String, sheet : String, column : String ) {
	...
	macro public static function parseTextToTranslate(params : Array<Expr>) {
		...
		var column = getString(ecolumn);
		var sheet = getString(esheet);
		var bytes = getODSCache(file, efile.pos, "String", sheet + Context.signature(efilter), extractColumns.bind(esheet, ecolumn, efilter, ~/^[A-Za-z_]/) );
		
		if(CONTENT == null) {
			CONTENT = "//this file is generated by ods.Data.parseTextToTranslate() for translation purpose.\n";
		}
